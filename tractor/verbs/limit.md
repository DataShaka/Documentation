...
The Limit verb returns the top result(s) and filters out the rest of the points in the [Data package](../../package). The data can be limited to N points, where N is an integer and does not exceed the total number of points in the data package
...
2013-09-05[Company:Google][Source:YahooFinance][Symbol:GOOG]{High:879.88}The
...
###Example 2: Limit Number of Points For Differnt Shapes
