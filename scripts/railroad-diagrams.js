...
var temp = (function(options) {
	...
	Terminal.prototype.format = function(x, y, width) {
		...
		FakeSVG('rect', {x:x, y:y-11, width:this.width, height:this.up+this.down, rx:10, ry:10, class:'terminal-rect'}).addTo(this);
		FakeSVG('text', {x:x+this.width/2, y:y+4, class:'terminal-text'}, this.text).addTo(this);
			console.log(this);
		return this;
	}
