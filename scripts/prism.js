/* http://prismjs.com/download.html?themes=prism&languages=markup+css+clike+javascript+python+sql+git+fsharp */
...
Prism.languages.tractor =  {
	...
	'time' :/time|week|year|day|month/,
	'context' :/context|\[|\]/,
	'signal' :/signal|\{|\}/,
	'value' :/value/,
	'keyword': /desc|rolls of|asc|returns|adds|with/g,
	'verb': /\b(nothing|average|rank|roll by|pad|insert|replace|select|crop|group by|sort by|sum|calculate|parse|harvest|upload)\b/gi,
	'hitch': /~>/gi,
	'grouper': /\(|\)/g
}
;

Prism.languages.katsu =  {
	'time': /^[\d\-T:\.]+?(?=\[)/gm,
	'context' : /\[.*\]/gm,
	'signal':  /\{.+?:|\}/gm,
	'value':  /-?[\d]+.?[\d]*/gm
